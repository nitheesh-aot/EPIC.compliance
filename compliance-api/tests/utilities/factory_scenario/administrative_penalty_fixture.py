...
from tests.utilities.factory_scenario.administrative_penalty_scenario import (
    AdministrativePenaltyScenario,
)


@pytest.fixture
def created_administrative_penalty(created_inspection, created_inspection_requirement, session):
    """Create and return an Administrative Penalty."""
    administrative_penalty_data = copy.copy(AdministrativePenaltyScenario.default_value.value)
    administrative_penalty_data["inspection_id"] = created_inspection.id
    administrative_penalty_data["issuing_officer_id"] = created_inspection.primary_officer_id
    administrative_penalty_data["inspection_requirement_ids"] = [created_inspection_requirement.id]
...
def created_administrative_penalty_requirement_map(
    ...
    administrative_penalty_requirement_map = AdministrativePenaltyInspectionRequirementMap(
