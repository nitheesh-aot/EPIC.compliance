  ...
  const debouncedOnMouseMove = useDebounce(
    (event: MouseEvent) => {
      ...
      if (tableDOMElement) {
        ...
        if (
          parentElement &&
          parentElement.classList.contains("editor-tableScrollableWrapper")
        ) {
          tableHasScroll =
        ...
        if (hoveredRowNode) {
          ...
          setPosition({
            ...
            left:
              (tableHasScroll && parentElement
                ...
                : tableElemLeft - editorElemLeft) + 12,
            top: tableElemBottom - editorElemY + 18,
            width:
              tableHasScroll && parentElement
          ...
          setPosition({
            height: tableElemHeight,
            left: tableElemRight - editorElemLeft + 14,
            top: tableElemY - editorElemY + 16,
    ...
    <>
      {isShownRow && (
        <Button
          ...
          size="small"
        >
          <AddCircle fontSize="inherit" color="action" />
        </Button>
      )}
      {isShownColumn && (
        <Button
