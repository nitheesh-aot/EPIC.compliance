...
describe("LexicalEditor Component", () => {
  ...
  it("renders mention node correctly", () => {
    const mentionsList: MentionData[] = [
      { id: 1, name: "John Doe" },
      { id: 2, name: "Jane Smith" },
    ];
    ...
    cy.get(".editor-input").click().type("@John");
    ...
    cy.get(".mention").should("contain", "John Doe");
  });

  it("does not allow text insertion before mention node", () => {
    const mentionsList: MentionData[] = [
      { id: 1, name: "John Doe" },
      { id: 2, name: "Jane Smith" },
    ];
    ...
    cy.get(".mention").first().type("{leftArrow}Hello");
    cy.get(".mention").should("not.exist");
  });

  it("does not allow text insertion after mention node", () => {
    const mentionsList: MentionData[] = [
      { id: 1, name: "John Doe" },
      { id: 2, name: "Jane Smith" },
    ];
    ...
    cy.get(".mention").first().type("{rightArrow}Hello");
    cy.get(".mention").should("not.contain", "Hello");
  });

  it("renders multiple mention nodes correctly", () => {
    const mentionsList: MentionData[] = [
      { id: 1, name: "John Doe" },
      { id: 2, name: "Jane Smith" },
    ];
    ...
    cy.get(".editor-input").click().type(" @Jane");

    cy.get(".mentions-menu").should("exist");
    cy.get("li").contains("Jane Smith").click();

    cy.get(".mention").should("exist");
    cy.get(".mention").should("contain", "Jane Smith");
  });
});
