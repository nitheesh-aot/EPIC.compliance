...
const mockChargeRecommendation: ChargeRecommendation = {
  ...
  court_appearances:
    "March 15, 2024 - Initial appearance\nApril 20, 2024 - Trial date set",
  judgment: mockJudgmentOption,
  judgment_date: "2024-04-20",
  sentence_date: "2024-05-01",
  sentence_type: "Fine and probation",
  is_active: true,
